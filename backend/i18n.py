...
STRINGS = {
    ...
    "feature_routes": {"vi": "Tra cứu tuyến đường", "en": "Browse bus routes"},
    "feature_lookup": {"vi": "Tìm điểm đi - điểm đến", "en": "Origin-destination lookup"},
    "feature_arrival": {"vi": "Giờ xe đến trạm & tổng thời gian", "en": "Arrival time & total travel time"},
    "hero_subtitle": {
    ...
    "map_load_error": {
        "vi": "⚠️ Không thể tải bản đồ cho lựa chọn hiện tại. Vui lòng thử lại.",
        "en": "⚠️ Couldn't load the map for the current selection. Please try again.",
    },
    ...
    "subsidized_yes": {"vi": "💚 Có trợ giá HSSV", "en": "💚 Student-subsidized"},
    "subsidized_no": {"vi": "🔶 Không trợ giá", "en": "🔶 Not subsidized"},
    "operated_by": {"vi": "Vận hành bởi", "en": "Operated by"},
    "compare_title": {"vi": "So sánh nhanh các phương án", "en": "Quick comparison"},
    "n_transfers_short": {"vi": "chuyển", "en": "transfer(s)"},
    "n_stops_short": {"vi": "trạm", "en": "stops"},
    "transfer_flow": {"vi": "Chuyển tuyến tại", "en": "Transfer at"},
    "popular_routes": {"vi": "🔥 Một số tuyến tiêu biểu", "en": "🔥 Popular route examples"},
    "try_nearby": {
        "vi": "Không có đường đi trực tiếp/1 lần chuyển giữa 2 điểm này. Thử với điểm gần đó:",
        "en": "No direct or 1-transfer route between these two points. Try a nearby stop instead:",
    },
    "map_empty_hint": {
